/*
  # Esquema Completo do Sistema de Lotérica

  1. Tipos e Funções
    - Enum `user_type` para tipos de usuário
    - Funções auxiliares para RLS e triggers
  ...
  2. Tabelas Principais
    ...
    - `product_reports` - Relatórios de produtos
    - `supply_reports` - Relatórios de suprimento
